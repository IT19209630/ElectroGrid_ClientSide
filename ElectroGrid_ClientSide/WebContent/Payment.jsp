...
<nav class="navbar navbar-expand-md navbar-dark" style="background-color: 	#5353ff">
                    ...
                    <ul class="navbar-nav">
                        <li><a href="Index.jsp" class="nav-link">Electro Grid</a></li>
                    </ul>
                </nav>
</head>
<body>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-6">
            <h6>About</h6>
            <p class="text-justify">M.M Yomal Sammika <i> </i> I used java , tomcat , mysql and JAX-RS Restful webservice as our tools to create our platform..</p>
          </div>
